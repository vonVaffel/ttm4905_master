...
\textbf{Variable costs} & \begin{tabular}[c]{@{}l@{}}Deployment of services\\ Counseling\\ Integration of services\end{tabular} & \begin{tabular}[c]{@{}l@{}}Hardware\\ Marketing\end{tabular}                                                               \\ \hline
\end{tabular}
\end{table}

\section{Summary of the Business Model Canvas}
Below follows a visual representation of the business model in the Business Model Canvas-framework:
